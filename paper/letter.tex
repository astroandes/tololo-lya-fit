...
In this paper we review first the observational characteristics of
\tol, then we summarize the main feature of the multiphase and
rotation models and explain how we fit the free parameters in the
model to the \lya\ line shape in \tol.
We use the kinematic result to interpret them in terms of the
dynamical mass that should be present in \tol.
