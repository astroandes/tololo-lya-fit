...
Usually the Ly-$\alpha$ line has a single or asymmetric double peak. 
...
$r_s\approx 2.0$ kpc (corresponding to the estimated 3D half-light
radius), 
the results from the rotational velocity correspond to a
dynamical mass of $M_{\rm dyn} \approx 5.45\times 10^{10} M_{\odot}$,
while the velocity dispersion in the multiphase model corresponds to a
$M_{\rm dyn}=2.8^{+1.3}_{-1.2}\times 10^{9}$ $M_{\odot}$. 
