...
dispersion of $71^{+17}_{-25}$ km s$^{-1}$ with outflows of
$79^{+167}_{-60}$ km s$^{-1}$) consistent with a dynamical mass on
the order of $5\times 10^9$ solar masses, which is at least $20$ times
