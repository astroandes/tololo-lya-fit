...
2. [General paragrph about the expected Lyman-alpha emission]. Almost
fifty years ago \cite{PartridgePeebles} it was realized that young
galaxies should have a strong Lyman-$\alpha$ line emission. 
This theoretical prediciotn was only confirmed XX year later. 
Currently, Lyman Alpha Emitting galaxies are commonly measure in
surveys. 

3. [The link betwween high-z galaxies and lyman alpha, LARS]

4. [Observations require interpretation, common features and
...
medium. State-of-the-art models 

5. [Rotation and the expected features.]
...
6. [The charachteristics of the dwarf galaxy of interest as a puzzling
system]
...
7. [The results of the fit + Physical picture using other results]
...
8. [Possible interpretation of this results]

9. [Implications for outflow+rotation in existing samples.]
