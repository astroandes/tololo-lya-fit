...
and a Equivalent Width of $70$\AA, with the emission comming from a
region with approximate diameter ?? \cite{Fricke01}. There is an upper limit for the
...
$D<0.34$kpc. From this limit and the rotational velocity of $300$ km/s
we have in turn an upper limit for the dynamical mass of $6.6\times
10^{9}$ Msun, which is $\sim 25$ times larger than the $HI$ mass. 
