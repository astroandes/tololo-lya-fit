...
dispersion of $69^{+17}_{-15}$ km s$^{-1}$ with outflows of
...
the clump velocity dispersion  $\sigma_{\rm{cl}}=69^{+17}_{-15}$ \kms,
the clumps outflowing velocity $v_{\infty, \rm{cl}}=79^{+73}_{-42}$
\kms and the fraction of the \lya emission that is  coming
from the cold clumps  $P_{cl}=0.78^{+0.16}_{-0.43}$. 
...
From the multiphase model we obtained $v=69_{-15}^{+17}$ \kms
and $r=5$ kpc. 
