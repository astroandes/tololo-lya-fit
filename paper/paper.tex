...
Observations of other Compact Dwarf Galaxies (CDGs) also show 
that the kinematics can renge from pure rotation and low velocity
...
for different dark matter halos and the estimates for \tol.
...
Spectrograph (\citep{2002Msngr.110....1P})
