...
$10^{11}$ M$_{\odot}$; conditions similar to those of Dwarf Elliptical Galaxies.
...
multiphase model, it will be the basis to study evolutionary processes that
might be at play during primordial galaxy evolution.
\end{abstract}
...
As a test, we run a small set of 100 additional radiative transfer simulations
with random values for all parameters, except for $\sigma_{\rm cl}$,
$v_{\infty {\rm cl}}$, $P_{\rm cl}$ which are within the derived
constraints.
...
than $1$ \kms.  
This leads us to prefer the multiphase model as it provides at least
some consistency with kinematic properties of dE galaxies.
...
First, dwarf ellipticals are found either in clusters or groups of
galaxies; while \tol\ does not belong either to a group or a cluster
\citep{2001AJ....121..169F,}. 
The second problem is that, unlike dE, \tol\ hosts a bright and compact
...
We give preference to the multiphase model as it produces kinematic
conditions that are similar to those in dwarf ellipticals, while the
...
different from dwarf ellipticals.
...
spectroscopy. 
If our results are confirmed, this would open up a new line of more detailed
enquiries to understand how a compact dwarf galaxy can have the
structural characteristics similar to a dwarf elliptical while being
at the same time isolated and sustaining large starburst.
Such and investigation could provide an evolutionary between star forming
and quiescent stages of dwarf galaxy evolution.
