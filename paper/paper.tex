...
{\bf \tol\ presents a \lya emission line with puzzling fetures.}
...
mass estimate. 
{\bf This value should be considered an upper bound as lower values
  could be achieved if one considers instead a cored profile.}
{\bf More realistic mass estimates can only achieved by detailed mass
  modelling once \tol's full rotation curve   becomes available.} 
...
resolution, spectral coverage and field of view required to produce
H$\alpha$ velocity maps to perform the kind of study presented by
\citet{2015A&A...577A..21C} on CDGs or \citet{Herenz16} on nearby
