...
such kinematic state in primordial \lya emitting galaxies, opening
{\bf the opportunity to constrain models of star formation and
  feedback in the first generation of galaxies.}
\end{abstract}
...
dispersion to high velocity dispersion without rotation
...
cannot be simulated with existing numerical implementations and 
...
\caption{Basic observational characteristics of \tol\ 
  \citep{Thuan97}.
The 2D half-light radius is
computed from the results reported by \citet{2001AJ....121..169F}.
\label{obstable}}
\end{table}
...
$v_{\infty,{\rm cl}}$ and $\beta_{\rm cl}$, {\bf where $\beta_{\rm cl}$ is
the exponent defining the steepness of the radial velocity profile. }
...
\tol\ presents an atypical \lya spectrum. 
...
continuum and promiment emission lines to finally compute velocitity
...
{\bf This estimate should be considered an upper bound as lower values
...
on nearby \lya\ emitting galaxies.}
...
\bibitem[\protect\citeauthoryear{{Cair{\'o}s}, {Caon}  \&
  {Weilbacher}}{{Cair{\'o}s} et~al.}{2015}]{2015A&A...577A..21C}
{Cair{\'o}s} L.~M.,  {Caon} N.,   {Weilbacher} P.~M.,  2015, \mn@doi [\aap]
  {10.1051/0004-6361/201322518}, \href
  {http://adsabs.harvard.edu/abs/2015A%26A...577A..21C} {577, A21}
...
\bibitem[\protect\citeauthoryear{{Hook}, {J{\o}rgensen}, {Allington-Smith},
  {Davies}, {Metcalfe}, {Murowinski}  \& {Crampton}}{{Hook}
  et~al.}{2004}]{2004PASP..116..425H}
{Hook} I.~M.,  {J{\o}rgensen} I.,  {Allington-Smith} J.~R.,  {Davies} R.~L.,
  {Metcalfe} N.,  {Murowinski} R.~G.,   {Crampton} D.,  2004, \mn@doi [\pasp]
  {10.1086/383624}, \href {http://adsabs.harvard.edu/abs/2004PASP..116..425H}
  {116, 425}
...
\bibitem[\protect\citeauthoryear{{Le F{\`e}vre} et~al.,}{{Le F{\`e}vre}
  et~al.}{2003}]{2003SPIE.4841.1670L}
{Le F{\`e}vre} O.,  et~al., 2003, in {Iye} M.,  {Moorwood} A.~F.~M.,  eds,
  \procspie Vol. 4841, Instrument Design and Performance for Optical/Infrared
  Ground-based Telescopes. pp 1670--1681, \mn@doi{10.1117/12.460959}
...
\bibitem[\protect\citeauthoryear{{Pasquini} et~al.,}{{Pasquini}
  et~al.}{2002}]{2002Msngr.110....1P}
{Pasquini} L.,  et~al., 2002, The Messenger, \href
  {http://esoads.eso.org/abs/2002Msngr.110....1P} {110, 1}
