...
We focus on showing how  two physically motivated models that can be suceessful
in reproducing \tol's \lya\ line morphology. 
It is not our aim to reject the existence of different models
that reproduce the observed features in \tol. 
Indeed more complex models with multiple kinematic components could
be also sucessful.
