...
\sigmaclump\ with outflows of \inftyclump\ while the bulk rotation
velocity is constrained to be $348^{+75}_{-48}$ \kms.
...
Such and investigation could provide an evolutionary link between star-forming
