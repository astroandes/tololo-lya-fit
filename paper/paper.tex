...
velocities found by our models, it would provide additional support to
radiative transfer modelling as a technique to constrain 
the kinematical state of \lya\ emitting galaxies.
\end{abstract}
%\lya\ modelling as complementary way to estimate dynamical masses in
...
line's center.
Attempts to explain these to features with conventional models have
not been succesfyul \citep{mashesse03,2015A&A...578A...7V}.      
...
We focus on showing how two physically motivated models can be sucessful
in reproducing \tol's \lya\ line morphology. 
We do not claim that we have discarded the existence of different
undiscovered models that reproduce the observed features in \tol.
More involved models with multiple kinematic components could
in principple be also sucessful.
We only present the existence of two simple good models.
